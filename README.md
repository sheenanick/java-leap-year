...
This is a web application that takes a year and returns whether it is a leap year or not.
...
* `git clone https://github.com/sheenanick/java-leap-year` to clone this repository
* `gradle run`
